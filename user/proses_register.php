...
if($_POST){
    ...
    */
    ...
    $insert=mysqli_query($conn,"insert into pelanggan (nama_pelanggan, alamat, telp, username, password) value ('".$nama."','".$alamat."','".$telp."','".$username."','".md5($password)."')") or die(mysqli_error($conn));
